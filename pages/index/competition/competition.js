// pages/index/competition/competition.js
const app = getApp()
Page({
  ...
  getDetail: function () {
    var that = this;
      ...
      console.log("20200705",res);
      that.setData({
        infoList: res,
        // com_inf_name: res.com_inf_name
      })
    });
  },
  ...
  // getSign: function () {
  //   var that = this;
  //   app.func.req('get_sign', { user_id: that.data.user_id }, 'GET', function (res) {
  //     console.log("20200705res", res);
  //     that.setData({
  //       items: res
  //     })  
