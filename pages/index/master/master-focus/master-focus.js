// pages/index/master/master-focus/master-focus.js
const app = getApp()
Page({
  ...
  getFocus: function() {
    var that = this;
    app.func.req('great_dynamic', { pageSize: 100, page: 1, in_user_id: that.data.master_id, query: 4, openid: that.data.openid }, 'GET', function (res) {
      // console.log(res);
      var focusList = res;
      that.setData({
        focusList: focusList
